...
const DIAGRAMAS = [
  {
    ...
    titulo: 'Casos de Uso',
    versao: 'v3',
    src: '/uml/casos-de-uso/caso-de-uso-v3.png',
    cor: '#2563eb',
    bg: '#eff6ff',
    ...
    puml: 'frontend/public/uml/casos-de-uso/caso-de-uso-v3.puml',
  },
  {
    id: 'classes',
    titulo: 'Diagrama de Classes',
    versao: 'v4',
    src: '/uml/classes/classes-v4.png',
    cor: '#7c3aed',
    bg: '#f5f3ff',
    ...
    puml: 'frontend/public/uml/classes/classes-v4.puml',
  },
  {
    id: 'componentes',
    titulo: 'Diagrama de Componentes',
    versao: 'v4',
    src: '/uml/componentes/componentes-v4.png',
    cor: '#0891b2',
    bg: '#ecfeff',
    ...
    puml: 'frontend/public/uml/componentes/componentes-v4.puml',
  },
  {
    id: 'implantacao',
    titulo: 'Diagrama de Implantação',
    versao: 'v3',
    src: '/uml/implantacao/implantacao-v3.png',
    cor: '#059669',
    bg: '#f0fdf4',
    ...
    puml: 'frontend/public/uml/implantacao/implantacao-v3.puml',
  },
  {
    id: 'pacotes',
    titulo: 'Diagrama de Pacotes',
    versao: 'v3',
    src: '/uml/pacotes/pacotes-v3.png',
    cor: '#d97706',
    bg: '#fffbeb',
    ...
    puml: 'frontend/public/uml/pacotes/pacotes-v3.puml',
  },
  {
    id: 'estados',
    titulo: 'Transição de Estados do Pedido',
    versao: 'v1',
    src: '/uml/estados/estados-pedido.png',
    cor: '#dc2626',
    bg: '#fef2f2',
    ...
    puml: 'frontend/public/uml/estados/estados-pedido-v1.puml',
  },
];
